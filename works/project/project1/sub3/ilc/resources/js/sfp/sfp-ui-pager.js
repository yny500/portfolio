...
$.widget( "sfp.pager", {
	...
	_onClick : function(){
		if($.isFunction(this.options.click)){
			this.options.click.call(this, $.extend({}, this.options.paging, { sortProp : this.sortProp, direction : this.direction}));
		}
	},
	...
	setPage : function(paging){
		const pageTag = [];
		paging = $.extend({}, this.options.paging, paging);

		let last = ~~(paging.number / paging.countPerPages) * paging.countPerPages + paging.countPerPages;
