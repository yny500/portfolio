...
$(function(){
	window.POPHeader = (function($){
		...
		, _bindEvent = function(){
			...
			$(document).on("focus", "*:not(#header_title)", function(e){
				$(e.target).blur();
				$("#header_title").focus();
			});
			...
			$(".util-menu .setting").click(function(e) {
				e.preventDefault();
				Dialog.open(SFPURL.getUrl("/solutions/pop/pop-setting.popdialog"), { width : "510px", height : "500px", isHiddenCloseBtn : true }, getSettingInfo(), function(result){
...
//						getWorkStationInfo();
			...
			$(".util-menu .ing-order").click(function(e) {
				e.preventDefault();
				Dialog.open(SFPURL.getUrl("/solutions/pop/work-ing-order-info.popdialog"), { width : "600px", height : "900px", isHiddenCloseBtn : true }, {workStationId : getWorkStationId()}, function(result){
